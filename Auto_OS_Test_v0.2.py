...
def os_input():
    while True:
        try:
            user_input=int(input('Which OS is currently under test?:\n1. Ubuntu\n2. Windows\n3. CentOS\n4. Red Hat Enterprise Linux\n5. OpenSUSE Leap\n Please select a number 1-5 and press \'Enter\': '))
            if 1 <= user_input <= 5:
                if user_input == 1:
                    log_message('OS: Ubuntu\n')
                    return 'Linux'
                
                elif user_input == 2:
                    log_message('OS: Windows\n')
                    return 'Windows'
                    
                elif user_input == 3:
                    log_message('OS: CentOS\n')
                    return 'CentOS'
                    
                elif user_input == 4:
                    log_message('OS: Red Hat Enterprise Linux\n')
                    return 'Red Hat Enterprise Linux'
                    
                elif user_input == 5:
                    log_message('OS: OpenSUSE Leap\n')
